package com.zhouwei.md.materialdesignsamples.view;
...
public class ClearEditText extends EditText {
    ...
    protected void onDetachedFromWindow() {
        ...
        this.dRight = null;
//        this.dRight = getResources().getDrawable(R.drawable.ico_del);
        this.rBounds = null;
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent) {
        if ((this.dRight != null) && (paramMotionEvent.getAction() == 1)) {
            ...
            boolean yFlag = false;
            //得到用户的点击位置，模拟点击事件
            xFlag = paramMotionEvent.getX() > getWidth() - (this.dRight.getIntrinsicWidth() + getCompoundPaddingRight
                    ()) &&
                    paramMotionEvent.getX() < getWidth() - (getTotalPaddingRight() - getCompoundPaddingRight());

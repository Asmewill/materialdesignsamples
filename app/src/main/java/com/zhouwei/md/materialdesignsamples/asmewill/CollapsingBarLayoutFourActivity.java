...
public class CollapsingBarLayoutFourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.collapsingbar_layout_four);
        ButterKnife.bind(this);

        bac.setAlpha(0f);
        totalHeight = SizeUtils.dp2px(180);
        toolBarHeight = SizeUtils.dp2px(50);
        offSetHeight = totalHeight - toolBarHeight;

        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SnackbarUtils.with(fab).setMessage("这是测试按钮").showError();
            }
        });
